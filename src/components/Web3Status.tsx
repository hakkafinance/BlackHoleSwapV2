      ...
      <Dialog isOpen={isOpen} onDismiss={() => setIsOpen(false)}>
        {!active || isShowConnectors ? (
          ...
          <>
            <WalletSection>
              <StyledAccountIcon />
              <SubTitle>{getNetworkName(chainId as ChainId)}</SubTitle>
              <Title>{shortenAddress(account as string)}</Title>
              <ChangeWalletButton onClick={() => setIsShowConnectors(true)}>
                Change Wallet
              </ChangeWalletButton>
            </WalletSection>
            <TransactionSection>
              ...
              {Object.keys(transactions).map((hash) => (
                <TransactionItem key={hash}>
                  ...
                  <TransactionStatus>
                    {!!transactions[hash].receipt ? 'Confirm' : 'Pending'}
                  </TransactionStatus>
                </TransactionItem>
              ))}
            </TransactionSection>
